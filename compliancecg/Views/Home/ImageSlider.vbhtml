...
<div id="jssor_1">
    <div id="jssor_2" data-u="slides" style="height:800px;overflow:hidden;">
...
<script type="text/javascript">
    var width = document.getElementById('PartialViewContainer').offsetWidth;
    var div = document.getElementById("jssor_2");
