...
<head>
    ...
    <style>
        /*.imgLinkButton {
            background: url('~/Content/Images/Logo G White-01.png') no-repeat center right;
            display: block;
...
<body>
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                @*@Html.ActionLink("CCG Compliance", "Index", "Home", New With {.class = "imgLinkButton"})*@
    ...
    @If Request.IsAuthenticated = True Then
        @Html.Partial("_LoginAuthenticated2a")
        @RenderBody()
        @*@<div id="wrapper">
