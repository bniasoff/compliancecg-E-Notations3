...
@Html.DevExpress().FileManager(Sub(settings)
                                        ...
                                        settings.CallbackRouteValues = New With {Key .Controller = "DocumentManager", Key .Action = "FileManagerPartial"}

                                        settings.DownloadRouteValues = New With {Key .Controller = "DocumentManager", Key .Action = "FileManagerPartialDownload"}
                                        ...
                                        settings.SettingsFileList.View = FileListView.Thumbnails
