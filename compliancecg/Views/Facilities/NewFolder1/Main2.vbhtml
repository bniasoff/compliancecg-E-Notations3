...
End code
    ...
    <div style="z-index:1000;">
        <div>
            ...
            @Html.EJS().Tab("ej2Tab").Animation(Function(anim) anim.Previous(New TabTabActionSettings With {.Effect = "SlideRight"})).HeightAdjustMode(HeightStyles.Auto).OverflowMode(OverflowMode.Popup).Selected("TabSelected").Items(TabTabItems).Width("1500px").Height("800px").SelectedItem(0).Created("TabCreated").HeaderPlacement(HeaderPosition.Left).HeightAdjustMode(HeightStyles.Content).Render()
