...
Namespace Identity.Test
    Public Class LoginsTest
        '  <Fact>
        Public Function LinkUnlinkDeletesTest() As Task
            Try
                ...
                Dim C1 = mgr.GetLogins(user.Id).Count
                mgr.AddLoginAsync(user.Id, userLogin1)
                C1 = user.Logins.Where(Function(l) l.ProviderKey = "p1-1").Count
