...
Public NotInheritable Class OdbcRoleProvider
    ...
    Public Overrides Sub Initialize(name As String, config As NameValueCollection)
        ...
        '
        ' pConnectionStringSettings = ConfigurationManager.ConnectionString(ConnectionStrings.SBSMembershipConnectionStringName)
    ...
    Public Overrides Sub AddUsersToRoles(usernames As String(), rolenames As String())
        ...
        Dim cmd As OdbcCommand = New OdbcCommand("INSERT INTO UsersInRoles " &
    ...
    Public Overrides Sub CreateRole(rolename As String)
        ...
        Dim conn As OdbcConnection = New OdbcConnection(connectionString)
        Dim cmd As OdbcCommand = New OdbcCommand("INSERT INTO Roles " &
    ...
    Public Overrides Function DeleteRole(ByVal rolename As String, ByVal throwOnPopulatedRole As Boolean) As Boolean
        ...
        Dim conn As OdbcConnection = New OdbcConnection(connectionString)
        Dim cmd As OdbcCommand = New OdbcCommand("DELETE FROM Roles " &
        ...
        Dim cmd2 As OdbcCommand = New OdbcCommand("DELETE FROM UsersInRoles " &
                " WHERE Rolename = ? AND ApplicationName = ?", conn)
    ...
    Public Overrides Function GetAllRoles() As String()
        ...
        Dim conn As OdbcConnection = New OdbcConnection(connectionString)
        Dim cmd As OdbcCommand = New OdbcCommand("SELECT Rolename FROM Roles " &
    ...
    Public Overrides Function GetRolesForUser(ByVal username As String) As String()
        ...
        Dim cmd As SqlCommand = New SqlCommand("aspnet_UsersInRoles_GetRolesForUser", conn)
        ...
        If tmpRoleNames.Length > 0 Then
            ' Remove trailing comma.
            tmpRoleNames = tmpRoleNames.Substring(0, tmpRoleNames.Length - 1)
            Roles = tmpRoleNames.Split(CChar(","))
            Return tmpRoleNames.Split(CChar(","))
        End If
    ...
    Public Overrides Sub RemoveUsersFromRoles(ByVal usernames As String(), ByVal rolenames As String())
        ...
        Dim conn As OdbcConnection = New OdbcConnection(connectionString)
        Dim cmd As OdbcCommand = New OdbcCommand("DELETE FROM UsersInRoles " &
                " WHERE Username = ? AND Rolename = ? AND ApplicationName = ?", conn)
    ...
    Public Overrides Function RoleExists(ByVal rolename As String) As Boolean
        ...
        Dim conn As OdbcConnection = New OdbcConnection(connectionString)
        Dim cmd As OdbcCommand = New OdbcCommand("SELECT COUNT(*) FROM Roles " &
                  " WHERE Rolename = ? AND ApplicationName = ?", conn)
    ...
    Public Sub New()
        '  connectionString = ConnectionStrings.SBSMembershipConnectionString.ConnectionString
        pApplicationName = "SBSWeb"
